    ...
    module Adapters
      module RethinkDB
        ...
        class Query
          ...
          #
          # @see Hanami::Model::Adapters::RethinkDB::Query#negate!
          #
          # @api private
          # @since 0.1.0
          OPERATORS_MAPPING = {
          ...
          # Initialize a query
          #
          # @param collection [Hanami::Model::Adapters::RethinkDB::Collection] the
          #   collection to query
          #
          ...
          # @since 0.1.0
          #
          # @see Hanami::Model::Adapters::RethinkDB::Query#reverse_order
          #
          # @example Single column
          #
          #   query.order(:name)
          ...
          #
          # @param query [Hanami::Model::Adapters::RethinkDB::Query] the query to apply
          #
          # @return [Hanami::Model::Adapters::RethinkDB::Query] a new query with the
          #   merged conditions
          #
          # @api private
          # @since 0.1.0
